...
$update=false;
$delete=false;
//INSERT INTO `notes` (`srno`, `title`, `description`, `tstamp`) VALUES (NULL, 'Buy Gift for MOm', 'Moms Birthday Buy Something Great for Her', current_timestamp());

//connecticing a data base
  ...
  if (isset( $_POST['snoEdit'])){
    ...
    if($result){
     $update=true;
      ...
      //echo "not updated the record successfully";
  }
}
  //insert value using variable
  else{
      $title = $_POST["title"];
...
<head>
 ...
 <link rel="stylesheet" href="//cdn.datatables.net/2.0.7/css/dataTables.dataTables.min.css">
   ...
   <title>KeepNotes-Notes Make You Easy!</title>
   <script> 
